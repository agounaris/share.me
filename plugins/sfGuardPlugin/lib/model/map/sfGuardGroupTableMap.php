...
class sfGuardGroupTableMap extends TableMap {
    ...
    $this->addRelation('LDAPSfGroup', 'LDAPSfGroup', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), 'CASCADE', null);
    $this->addRelation('sfGuardGroupProject', 'sfGuardGroupProject', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), 'CASCADE', null);
	} // buildRelations()
