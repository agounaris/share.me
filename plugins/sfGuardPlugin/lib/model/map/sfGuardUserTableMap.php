...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('LDAPSfUser', 'LDAPSfUser', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('Client', 'Client', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), null, null);
    $this->addRelation('Project', 'Project', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), null, null);
    $this->addRelation('Image', 'Image', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), null, null);
    $this->addRelation('ImageComment', 'ImageComment', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), null, null);
    $this->addRelation('sfGuardUserProject', 'sfGuardUserProject', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
	} // buildRelations()
