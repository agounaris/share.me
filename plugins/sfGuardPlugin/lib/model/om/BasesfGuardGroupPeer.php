...
abstract class BasesfGuardGroupPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in LDAPSfGroupPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		LDAPSfGroupPeer::clearInstancePool();

		// invalidate objects in sfGuardGroupProjectPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		sfGuardGroupProjectPeer::clearInstancePool();
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related LDAPSfGroup objects
			$criteria = new Criteria(LDAPSfGroupPeer::DATABASE_NAME);
			
			$criteria->add(LDAPSfGroupPeer::GROUP_ID, $obj->getId());
			$affectedRows += LDAPSfGroupPeer::doDelete($criteria, $con);

			// delete related sfGuardGroupProject objects
			$criteria = new Criteria(sfGuardGroupProjectPeer::DATABASE_NAME);
			
			$criteria->add(sfGuardGroupProjectPeer::GROUP_ID, $obj->getId());
			$affectedRows += sfGuardGroupProjectPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
