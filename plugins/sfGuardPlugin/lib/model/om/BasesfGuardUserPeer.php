...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in LDAPSfUserPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		LDAPSfUserPeer::clearInstancePool();

		// invalidate objects in sfGuardUserProjectPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related LDAPSfUser objects
			$criteria = new Criteria(LDAPSfUserPeer::DATABASE_NAME);
			
			$criteria->add(LDAPSfUserPeer::USER_ID, $obj->getId());
			$affectedRows += LDAPSfUserPeer::doDelete($criteria, $con);

			// delete related sfGuardUserProject objects
			$criteria = new Criteria(sfGuardUserProjectPeer::DATABASE_NAME);
			
			$criteria->add(sfGuardUserProjectPeer::USER_ID, $obj->getId());
			$affectedRows += sfGuardUserProjectPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
