...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array LDAPSfUser[] Collection to store aggregation of LDAPSfUser objects.
	 */
	protected $collLDAPSfUsers;

	/**
	 * @var        Criteria The criteria used to select the current contents of collLDAPSfUsers.
	 */
	private $lastLDAPSfUserCriteria = null;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collImages.
	 */
	private $lastImageCriteria = null;

	/**
	 * @var        array ImageComment[] Collection to store aggregation of ImageComment objects.
	 */
	protected $collImageComments;

	/**
	 * @var        Criteria The criteria used to select the current contents of collImageComments.
	 */
	private $lastImageCommentCriteria = null;

	/**
	 * @var        array sfGuardUserProject[] Collection to store aggregation of sfGuardUserProject objects.
	 */
	protected $collsfGuardUserProjects;

	/**
	 * @var        Criteria The criteria used to select the current contents of collsfGuardUserProjects.
	 */
	private $lastsfGuardUserProjectCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collLDAPSfUsers = null;
			$this->lastLDAPSfUserCriteria = null;
			...
			$this->collImageComments = null;
			$this->lastImageCommentCriteria = null;

			$this->collsfGuardUserProjects = null;
			$this->lastsfGuardUserProjectCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collLDAPSfUsers !== null) {
				foreach ($this->collLDAPSfUsers as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collImageComments !== null) {
				foreach ($this->collImageComments as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collsfGuardUserProjects !== null) {
				foreach ($this->collsfGuardUserProjects as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getLDAPSfUsers() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addLDAPSfUser($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getImageComments() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addImageComment($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getsfGuardUserProjects() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addsfGuardUserProject($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collLDAPSfUsers collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addLDAPSfUsers()
	 */
	public function clearLDAPSfUsers()
	{
		$this->collLDAPSfUsers = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collLDAPSfUsers collection (array).
	 *
	 * By default this just sets the collLDAPSfUsers collection to an empty array (like clearcollLDAPSfUsers());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initLDAPSfUsers()
	{
		$this->collLDAPSfUsers = array();
	}

	/**
	 * Gets an array of LDAPSfUser objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related LDAPSfUsers from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array LDAPSfUser[]
	 * @throws     PropelException
	 */
	public function getLDAPSfUsers($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collLDAPSfUsers === null) {
			if ($this->isNew()) {
			   $this->collLDAPSfUsers = array();
				...
				$criteria->add(LDAPSfUserPeer::USER_ID, $this->id);

				LDAPSfUserPeer::addSelectColumns($criteria);
				$this->collLDAPSfUsers = LDAPSfUserPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				LDAPSfUserPeer::addSelectColumns($criteria);
				if (!isset($this->lastLDAPSfUserCriteria) || !$this->lastLDAPSfUserCriteria->equals($criteria)) {
					$this->collLDAPSfUsers = LDAPSfUserPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastLDAPSfUserCriteria = $criteria;
		return $this->collLDAPSfUsers;
	}

	/**
	 * Returns the number of related LDAPSfUser objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related LDAPSfUser objects.
	 * @throws     PropelException
	 */
	public function countLDAPSfUsers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collLDAPSfUsers === null) {
			if ($this->isNew()) {
				...
				$count = LDAPSfUserPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastLDAPSfUserCriteria) || !$this->lastLDAPSfUserCriteria->equals($criteria)) {
					...
					$count = count($this->collLDAPSfUsers);
				}
			} else {
				$count = count($this->collLDAPSfUsers);
			}
	...
	/**
	 * Method called to associate a LDAPSfUser object to this object
	 * through the LDAPSfUser foreign key attribute.
	 *
	 * @param      LDAPSfUser $l LDAPSfUser
	 * @return     void
	 * @throws     PropelException
	 */
	public function addLDAPSfUser(LDAPSfUser $l)
	{
		if ($this->collLDAPSfUsers === null) {
			$this->initLDAPSfUsers();
		}
		if (!in_array($l, $this->collLDAPSfUsers, true)) { // only add it if the **same** object is not already associated
			array_push($this->collLDAPSfUsers, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Clients from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collClients === null) {
			if ($this->isNew()) {
			   $this->collClients = array();
				...
				$criteria->add(ClientPeer::CREATED_BY, $this->id);
	...
	public function countClients(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collClients === null) {
			if ($this->isNew()) {
				...
				$count = ClientPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Projects from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProjects === null) {
			if ($this->isNew()) {
			   $this->collProjects = array();
				...
				$criteria->add(ProjectPeer::CREATED_BY, $this->id);
	...
	public function getProjectsJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collProjects === null) {
			if ($this->isNew()) {
				...
				$this->collProjects = ProjectPeer::doSelectJoinClient($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collImages collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collImages collection (array).
	 *
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Images from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collImages === null) {
			if ($this->isNew()) {
			   $this->collImages = array();
				...
				$criteria->add(ImagePeer::CREATED_BY, $this->id);
	...
	public function countImages(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collImages === null) {
			if ($this->isNew()) {
				...
				$count = ImagePeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addImage(Image $l)
	{
		...
		if (!in_array($l, $this->collImages, true)) { // only add it if the **same** object is not already associated
			array_push($this->collImages, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getImagesJoinProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collImages === null) {
			if ($this->isNew()) {
				...
				$this->collImages = ImagePeer::doSelectJoinProject($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collImageComments collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addImageComments()
	 */
	public function clearImageComments()
	{
		$this->collImageComments = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collImageComments collection (array).
	 *
	 * By default this just sets the collImageComments collection to an empty array (like clearcollImageComments());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initImageComments()
	{
		$this->collImageComments = array();
	}

	/**
	 * Gets an array of ImageComment objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related ImageComments from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array ImageComment[]
	 * @throws     PropelException
	 */
	public function getImageComments($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collImageComments === null) {
			if ($this->isNew()) {
			   $this->collImageComments = array();
				...
				$criteria->add(ImageCommentPeer::CREATED_BY, $this->id);

				ImageCommentPeer::addSelectColumns($criteria);
				$this->collImageComments = ImageCommentPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				ImageCommentPeer::addSelectColumns($criteria);
				if (!isset($this->lastImageCommentCriteria) || !$this->lastImageCommentCriteria->equals($criteria)) {
					$this->collImageComments = ImageCommentPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastImageCommentCriteria = $criteria;
		return $this->collImageComments;
	}

	/**
	 * Returns the number of related ImageComment objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related ImageComment objects.
	 * @throws     PropelException
	 */
	public function countImageComments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collImageComments === null) {
			if ($this->isNew()) {
				...
				$count = ImageCommentPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastImageCommentCriteria) || !$this->lastImageCommentCriteria->equals($criteria)) {
					...
					$count = count($this->collImageComments);
				}
			} else {
				$count = count($this->collImageComments);
			}
	...
	/**
	 * Method called to associate a ImageComment object to this object
	 * through the ImageComment foreign key attribute.
	 *
	 * @param      ImageComment $l ImageComment
	 * @return     void
	 * @throws     PropelException
	 */
	public function addImageComment(ImageComment $l)
	{
		if ($this->collImageComments === null) {
			$this->initImageComments();
		}
		if (!in_array($l, $this->collImageComments, true)) { // only add it if the **same** object is not already associated
			array_push($this->collImageComments, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related ImageComments from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getImageCommentsJoinImage($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collImageComments === null) {
			if ($this->isNew()) {
				...
				$this->collImageComments = ImageCommentPeer::doSelectJoinImage($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collsfGuardUserProjects collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addsfGuardUserProjects()
	 */
	public function clearsfGuardUserProjects()
	{
		$this->collsfGuardUserProjects = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collsfGuardUserProjects collection (array).
	 *
	 * By default this just sets the collsfGuardUserProjects collection to an empty array (like clearcollsfGuardUserProjects());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initsfGuardUserProjects()
	{
		$this->collsfGuardUserProjects = array();
	}

	/**
	 * Gets an array of sfGuardUserProject objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related sfGuardUserProjects from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array sfGuardUserProject[]
	 * @throws     PropelException
	 */
	public function getsfGuardUserProjects($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collsfGuardUserProjects === null) {
			if ($this->isNew()) {
			   $this->collsfGuardUserProjects = array();
				...
				$criteria->add(sfGuardUserProjectPeer::USER_ID, $this->id);

				sfGuardUserProjectPeer::addSelectColumns($criteria);
				$this->collsfGuardUserProjects = sfGuardUserProjectPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				sfGuardUserProjectPeer::addSelectColumns($criteria);
				if (!isset($this->lastsfGuardUserProjectCriteria) || !$this->lastsfGuardUserProjectCriteria->equals($criteria)) {
					$this->collsfGuardUserProjects = sfGuardUserProjectPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastsfGuardUserProjectCriteria = $criteria;
		return $this->collsfGuardUserProjects;
	}

	/**
	 * Returns the number of related sfGuardUserProject objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related sfGuardUserProject objects.
	 * @throws     PropelException
	 */
	public function countsfGuardUserProjects(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collsfGuardUserProjects === null) {
			if ($this->isNew()) {
				...
				$count = sfGuardUserProjectPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastsfGuardUserProjectCriteria) || !$this->lastsfGuardUserProjectCriteria->equals($criteria)) {
					...
					$count = count($this->collsfGuardUserProjects);
				}
			} else {
				$count = count($this->collsfGuardUserProjects);
			}
	...
	/**
	 * Method called to associate a sfGuardUserProject object to this object
	 * through the sfGuardUserProject foreign key attribute.
	 *
	 * @param      sfGuardUserProject $l sfGuardUserProject
	 * @return     void
	 * @throws     PropelException
	 */
	public function addsfGuardUserProject(sfGuardUserProject $l)
	{
		if ($this->collsfGuardUserProjects === null) {
			$this->initsfGuardUserProjects();
		}
		if (!in_array($l, $this->collsfGuardUserProjects, true)) { // only add it if the **same** object is not already associated
			array_push($this->collsfGuardUserProjects, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related sfGuardUserProjects from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getsfGuardUserProjectsJoinProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collsfGuardUserProjects === null) {
			if ($this->isNew()) {
				...
				$this->collsfGuardUserProjects = sfGuardUserProjectPeer::doSelectJoinProject($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collLDAPSfUsers) {
				foreach ((array) $this->collLDAPSfUsers as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collClients) {
			...
			if ($this->collImageComments) {
				foreach ((array) $this->collImageComments as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collsfGuardUserProjects) {
				foreach ((array) $this->collsfGuardUserProjects as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
