...
abstract class BasesfGuardGroup extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array LDAPSfGroup[] Collection to store aggregation of LDAPSfGroup objects.
	 */
	protected $collLDAPSfGroups;

	/**
	 * @var        Criteria The criteria used to select the current contents of collLDAPSfGroups.
	 */
	private $lastLDAPSfGroupCriteria = null;

	/**
	 * @var        array sfGuardGroupProject[] Collection to store aggregation of sfGuardGroupProject objects.
	 */
	protected $collsfGuardGroupProjects;

	/**
	 * @var        Criteria The criteria used to select the current contents of collsfGuardGroupProjects.
	 */
	private $lastsfGuardGroupProjectCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collLDAPSfGroups = null;
			$this->lastLDAPSfGroupCriteria = null;

			$this->collsfGuardGroupProjects = null;
			$this->lastsfGuardGroupProjectCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collLDAPSfGroups !== null) {
				foreach ($this->collLDAPSfGroups as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collsfGuardGroupProjects !== null) {
				foreach ($this->collsfGuardGroupProjects as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getLDAPSfGroups() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addLDAPSfGroup($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getsfGuardGroupProjects() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addsfGuardGroupProject($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collLDAPSfGroups collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addLDAPSfGroups()
	 */
	public function clearLDAPSfGroups()
	{
		$this->collLDAPSfGroups = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collLDAPSfGroups collection (array).
	 *
	 * By default this just sets the collLDAPSfGroups collection to an empty array (like clearcollLDAPSfGroups());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initLDAPSfGroups()
	{
		$this->collLDAPSfGroups = array();
	}

	/**
	 * Gets an array of LDAPSfGroup objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardGroup has previously been saved, it will retrieve
	 * related LDAPSfGroups from storage. If this sfGuardGroup is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array LDAPSfGroup[]
	 * @throws     PropelException
	 */
	public function getLDAPSfGroups($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collLDAPSfGroups === null) {
			if ($this->isNew()) {
			   $this->collLDAPSfGroups = array();
				...
				$criteria->add(LDAPSfGroupPeer::GROUP_ID, $this->id);

				LDAPSfGroupPeer::addSelectColumns($criteria);
				$this->collLDAPSfGroups = LDAPSfGroupPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				LDAPSfGroupPeer::addSelectColumns($criteria);
				if (!isset($this->lastLDAPSfGroupCriteria) || !$this->lastLDAPSfGroupCriteria->equals($criteria)) {
					$this->collLDAPSfGroups = LDAPSfGroupPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastLDAPSfGroupCriteria = $criteria;
		return $this->collLDAPSfGroups;
	}

	/**
	 * Returns the number of related LDAPSfGroup objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related LDAPSfGroup objects.
	 * @throws     PropelException
	 */
	public function countLDAPSfGroups(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collLDAPSfGroups === null) {
			if ($this->isNew()) {
				...
				$count = LDAPSfGroupPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastLDAPSfGroupCriteria) || !$this->lastLDAPSfGroupCriteria->equals($criteria)) {
					...
					$count = count($this->collLDAPSfGroups);
				}
			} else {
				$count = count($this->collLDAPSfGroups);
			}
	...
	/**
	 * Method called to associate a LDAPSfGroup object to this object
	 * through the LDAPSfGroup foreign key attribute.
	 *
	 * @param      LDAPSfGroup $l LDAPSfGroup
	 * @return     void
	 * @throws     PropelException
	 */
	public function addLDAPSfGroup(LDAPSfGroup $l)
	{
		if ($this->collLDAPSfGroups === null) {
			$this->initLDAPSfGroups();
		}
		if (!in_array($l, $this->collLDAPSfGroups, true)) { // only add it if the **same** object is not already associated
			array_push($this->collLDAPSfGroups, $l);
			$l->setsfGuardGroup($this);
		}
	}

	/**
	 * Clears out the collsfGuardGroupProjects collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addsfGuardGroupProjects()
	 */
	public function clearsfGuardGroupProjects()
	{
		$this->collsfGuardGroupProjects = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collsfGuardGroupProjects collection (array).
	 *
	 * By default this just sets the collsfGuardGroupProjects collection to an empty array (like clearcollsfGuardGroupProjects());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initsfGuardGroupProjects()
	{
		$this->collsfGuardGroupProjects = array();
	}

	/**
	 * Gets an array of sfGuardGroupProject objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardGroup has previously been saved, it will retrieve
	 * related sfGuardGroupProjects from storage. If this sfGuardGroup is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array sfGuardGroupProject[]
	 * @throws     PropelException
	 */
	public function getsfGuardGroupProjects($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collsfGuardGroupProjects === null) {
			if ($this->isNew()) {
			   $this->collsfGuardGroupProjects = array();
				...
				$criteria->add(sfGuardGroupProjectPeer::GROUP_ID, $this->id);

				sfGuardGroupProjectPeer::addSelectColumns($criteria);
				$this->collsfGuardGroupProjects = sfGuardGroupProjectPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				sfGuardGroupProjectPeer::addSelectColumns($criteria);
				if (!isset($this->lastsfGuardGroupProjectCriteria) || !$this->lastsfGuardGroupProjectCriteria->equals($criteria)) {
					$this->collsfGuardGroupProjects = sfGuardGroupProjectPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastsfGuardGroupProjectCriteria = $criteria;
		return $this->collsfGuardGroupProjects;
	}

	/**
	 * Returns the number of related sfGuardGroupProject objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related sfGuardGroupProject objects.
	 * @throws     PropelException
	 */
	public function countsfGuardGroupProjects(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collsfGuardGroupProjects === null) {
			if ($this->isNew()) {
				...
				$count = sfGuardGroupProjectPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastsfGuardGroupProjectCriteria) || !$this->lastsfGuardGroupProjectCriteria->equals($criteria)) {
					...
					$count = count($this->collsfGuardGroupProjects);
				}
			} else {
				$count = count($this->collsfGuardGroupProjects);
			}
	...
	/**
	 * Method called to associate a sfGuardGroupProject object to this object
	 * through the sfGuardGroupProject foreign key attribute.
	 *
	 * @param      sfGuardGroupProject $l sfGuardGroupProject
	 * @return     void
	 * @throws     PropelException
	 */
	public function addsfGuardGroupProject(sfGuardGroupProject $l)
	{
		if ($this->collsfGuardGroupProjects === null) {
			$this->initsfGuardGroupProjects();
		}
		if (!in_array($l, $this->collsfGuardGroupProjects, true)) { // only add it if the **same** object is not already associated
			array_push($this->collsfGuardGroupProjects, $l);
			$l->setsfGuardGroup($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardGroup is new, it will return
	 * an empty collection; or if this sfGuardGroup has previously
	 * been saved, it will retrieve related sfGuardGroupProjects from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardGroup.
	 */
	public function getsfGuardGroupProjectsJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collsfGuardGroupProjects === null) {
			if ($this->isNew()) {
				...
				$this->collsfGuardGroupProjects = sfGuardGroupProjectPeer::doSelectJoinClient($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collLDAPSfGroups) {
				foreach ((array) $this->collLDAPSfGroups as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collsfGuardGroupProjects) {
				foreach ((array) $this->collsfGuardGroupProjects as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
