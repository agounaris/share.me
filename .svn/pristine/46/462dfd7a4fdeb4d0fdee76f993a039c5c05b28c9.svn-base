...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_guard_user_project_list'    => new sfWidgetFormPropelChoice(array('model' => 'Project', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'sf_guard_user_project_list'    => new sfValidatorPropelChoice(array('model' => 'Project', 'required' => false)),
  ...
  public function addsfGuardUserProjectListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(sfGuardUserProjectPeer::USER_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(sfGuardUserProjectPeer::PROJECT_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(sfGuardUserProjectPeer::PROJECT_ID, $value));
    }
