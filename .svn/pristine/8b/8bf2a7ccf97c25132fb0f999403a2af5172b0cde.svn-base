...
abstract class BasesfGuardGroupForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_guard_group_project_list'    => new sfWidgetFormPropelChoice(array('multiple' => true, 'model' => 'Client')),
    ));
    ...
    $this->setValidators(array(
      ...
      'sf_guard_group_project_list'    => new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'Client', 'required' => false)),
    ));
  ...
  public function savesfGuardGroupProjectList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(sfGuardGroupProjectPeer::GROUP_ID, $this->object->getPrimaryKey());
