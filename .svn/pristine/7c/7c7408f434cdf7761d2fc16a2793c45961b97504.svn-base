...
abstract class BasesfGuardGroupFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_guard_group_project_list'    => new sfWidgetFormPropelChoice(array('model' => 'Client', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'sf_guard_group_project_list'    => new sfValidatorPropelChoice(array('model' => 'Client', 'required' => false)),
    ));
  ...
  public function addsfGuardGroupProjectListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(sfGuardGroupProjectPeer::GROUP_ID, sfGuardGroupPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(sfGuardGroupProjectPeer::CLIENT_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(sfGuardGroupProjectPeer::CLIENT_ID, $value));
    }
